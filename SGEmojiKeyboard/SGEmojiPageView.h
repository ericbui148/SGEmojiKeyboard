...
@protocol SGEmojiPageViewDelegate;

@interface SGEmojiPageView : UIView

@property (nonatomic, assign) id<SGEmojiPageViewDelegate> delegate;
...
@protocol SGEmojiPageViewDelegate <NSObject>
